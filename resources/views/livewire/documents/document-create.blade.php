    ...
    <div class="container mx-auto md:px-2 lg:mt-2">
        ...
        <div class="mb-6 lg:mb-12">
            <div class="flex justify-between items-start">
                <div class="flex-1">
                    <h1 class="lg:text-3xl font-bold text-gray-900 mb-4 dark:text-white">Tambah Dokumen Baru</h1>
                    <nav class="flex items-center space-x-2 text-sm">
                        ...
                        <span class="text-gray-900 font-medium dark:text-white">Tambah Baru</span>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <form wire:submit="save">
                ...
                <!-- Semua dokumen WAJIB dilindungi — hanya pilih tingkat keamanan   -->
                <!-- ================================================================ -->
                <div class="{{ $currentStep === 1 ? 'block' : 'hidden' }}">
                    <h3
                        ...
                        <i class="fas fa-shield-alt mr-2 text-emerald-500"></i>Keamanan Dokumen
                    </h3>

                    {{-- Notice: semua dokumen wajib dilindungi --}}
                    <div
                        ...
                        <svg class="w-5 h-5 text-blue-500 dark:text-blue-400 flex-shrink-0 mt-0.5" fill="none"
                        ...
                        <div>
                            <p class="text-sm font-semibold text-blue-900 dark:text-blue-100">
                                Semua dokumen wajib dilindungi secara otomatis
                            </p>
                            <p class="text-xs text-blue-700 dark:text-blue-300 mt-1">
                                Setiap dokumen akan mendapatkan hashing MD5, QR Code kepemilikan, file checksum,
                                dan audit log akses. Pilih tingkat keamanan sesuai kebutuhan dokumen Anda.
                            </p>
                        </div>
                    </div>
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="flex-shrink-0 w-10 h-10 rounded-full bg-gray-100 dark:bg-zinc-700 flex items-center justify-center">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-gray-400">Akses standar</div>
                                        </div>
                                    </div>
                                    <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div
                                            ...
                                            <svg class="w-5 h-5 text-orange-500 dark:text-orange-400"
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-gray-400">Akses terbatas</div>
                                        </div>
                                    </div>
                                    <div
                                        class="absolute top-3 right-3 opacity-0 peer-checked:opacity-100 transition-opacity">
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <div class="font-bold text-gray-900 dark:text-white">Sangat Rahasia</div>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">Akses ketat</div>
                                        </div>
                                    </div>
                                    <div
                                        class="absolute top-3 right-3 opacity-0 peer-checked:opacity-100 transition-opacity">
                    ...
                    {{-- Fitur keamanan yang selalu diterapkan --}}
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-emerald-900 dark:text-emerald-100 mb-2">
                                    Fitur keamanan yang diterapkan pada semua dokumen:
                                </p>
                                <ul class="text-xs text-emerald-800 dark:text-emerald-200 space-y-1">
                                    <li class="flex items-start gap-2">
                                        ...
                                        <span>MD5 hashing untuk verifikasi integritas</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg class="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0 mt-0.5"
                                            fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <label class="relative cursor-pointer h-full">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col items-center text-center flex-1">
                                            <div
                                                class="w-12 h-12 mb-3 flex items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-900/30">
                                            ...
                                            <div class="font-semibold text-gray-900 dark:text-white mb-1">Terbuka
                                            </div>
                                ...
                                <label class="relative cursor-pointer h-full">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col items-center text-center flex-1">
                                            <div
                                                class="w-12 h-12 mb-3 flex items-center justify-center rounded-full bg-yellow-100 dark:bg-yellow-900/30">
                                ...
                                <label class="relative cursor-pointer h-full">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col items-center text-center flex-1">
                                            <div
                                                class="w-12 h-12 mb-3 flex items-center justify-center rounded-full bg-red-100 dark:bg-red-900/30">
                ...
                <div class="{{ $currentStep === 5 ? 'block' : 'hidden' }}">
                    ...
                    <x-form.file-upload model="file" label="Upload File (PDF, DOC, DOCX, JPG, PNG, GIF, WEBP)"
                        accept=".pdf,.doc,.docx,.jpg,.jpeg,.png,.gif,.webp" maxSize="10MB" required
                        :file="$file" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="font-semibold
                                        @if ($security_level === 'sangat_rahasia') text-red-600 dark:text-red-400
                                        @elseif ($security_level === 'rahasia') text-orange-600 dark:text-orange-400
                                        @else text-gray-700 dark:text-gray-300 @endif">
                                        {{ ucfirst(str_replace('_', ' ', $security_level)) }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-semibold text-gray-900 dark:text-white">
                                        {{ $file ? $file->getClientOriginalName() : 'Belum diupload' }}
                                    </span>
                                </div>
                            </div>
                        </div>

                        {{-- Badge: semua dokumen dilindungi --}}
                        <div
                            class="mt-4 pt-4 border-t border-emerald-200 dark:border-emerald-700 flex items-center gap-2">
                            ...
                            <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-300">
                                Dokumen ini akan dilindungi dengan MD5 hashing dan QR Code kepemilikan secara otomatis
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div
            ...
            <div class="flex items-start gap-2 sm:gap-3">
                <div class="text-xs sm:text-sm text-emerald-800 dark:text-emerald-300 flex-1 min-w-0">
                    <p class="font-semibold mb-1 sm:mb-1.5">Informasi Upload:</p>
                    <ul class="list-disc list-inside space-y-0.5 sm:space-y-1 text-emerald-700 dark:text-emerald-400">
                        <li class="leading-relaxed">Format file yang didukung: PDF, DOC, DOCX, JPG, PNG, GIF, WEBP
                        </li>
                        <li class="leading-relaxed">Ukuran maksimal file: 10 MB</li>
                        <li class="leading-relaxed">File akan disimpan dengan aman di server</li>
                        <li class="leading-relaxed">Kode klasifikasi menggunakan standar KMA 44/2010</li>
                        <li class="leading-relaxed">Semua dokumen dilindungi dengan hashing dan QR Code secara
                            otomatis</li>
                    </ul>
                </div>
            </div>
