<div class="min-h-screen transition-colors duration-200 lg:p-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 font-medium text-sm sm:text-base mt-1">
                            Kelola kategori dokumen arsip Anda
                        </p>
                    </div>
                </div>
            </div>
    ...
    @if (session()->has('success'))
        <div
            class="mb-6 bg-emerald-50 dark:bg-emerald-900/20 border-2 border-emerald-200 dark:border-emerald-800 rounded-xl p-4 transition-all">
    ...
    <!-- Search Section -->
    <div class="bg-white dark:bg-zinc-900 rounded-2xl p-6 mb-6 border border-gray-200 dark:border-zinc-800">
        <div class="relative">
            ...
            <input type="text" wire:model.live="search" placeholder="Cari kategori..."
                class="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition">
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-3xl border border-gray-200 dark:border-zinc-800 overflow-hidden">
        ...
        <div class="p-4 sm:p-6 bg-gray-50 dark:bg-zinc-800/50 border-b border-gray-200 dark:border-zinc-800">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Daftar Kategori</h3>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-gray-50 dark:bg-zinc-800/70 border-b border-gray-200 dark:border-zinc-700">
                    <tr>
                        <th class="px-4 sm:px-6 py-3.5 text-left w-20">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-zinc-800 bg-white dark:bg-zinc-900">
                    @forelse ($categories as $index => $category)
                        <tr class="group hover:bg-gray-50 dark:hover:bg-zinc-800/30 transition-colors">
                            ...
                            <td class="px-4 sm:px-6 py-4">
                                <span
                                    class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-lg text-xs font-semibold">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <td colspan="5" class="px-6 py-20">
                                <div class="flex flex-col items-center justify-center text-center">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400 max-w-md mb-4">
                                        Mulai dengan menambahkan kategori baru atau ubah pencarian Anda
                                    </p>
                                    <a href="{{ route('categories.create') }}"
