                ...
                <div class="mb-8">
                    ...
                    <nav class="space-y-1">
                        <a href="{{ route('dashboard') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-full transition-all duration-200 group {{ request()->routeIs('dashboard') ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800' }}"
                            wire:navigate>
                        ...
                        <a href="{{ route('documents.index') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-full transition-all duration-200 group {{ request()->routeIs('documents.index') ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800' }}"
                            wire:navigate>
